 ...
 * 
 */
@WebServiceClient(name = "ListagemLivrosService", targetNamespace = "http://service.acervo.catolicasc.org/", wsdlLocation = "http://localhost:8180/livros?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LISTAGEMLIVROSSERVICE_QNAME = new QName("http://service.acervo.catolicasc.org/", "ListagemLivrosService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8180/livros?wsdl");
    ...
    public ListagemLivros getListagemLivrosPort() {
        return super.getPort(new QName("http://service.acervo.catolicasc.org/", "ListagemLivrosPort"), ListagemLivros.class);
    }
    ...
    public ListagemLivros getListagemLivrosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.acervo.catolicasc.org/", "ListagemLivrosPort"), ListagemLivros.class, features);
    }
